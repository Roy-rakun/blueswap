...
const Twap = () => {
  ...
  const playSound = () => {
    const audio = new Audio('/click-sound.mp3'); // Ganti dengan path sound effect 
    audio.play();
  };

  const handleTwap = () => {
    alert(`Executing Twap: ${fromToken} to ${toToken} on ${selectedNetwork}`);
  };
  ...
  return (
    ...
    >
      <div className="bg-white/10 dark:bg-[#1E3A8A]/10 backdrop-blur-md rounded-lg shadow-md max-w-md mx-auto p-6">
        <h2 className="text-2xl font-bold text-[#374151] dark:text-white mb-4">Twap</h2>
        {/* Link ke Swap dan Limit */}
